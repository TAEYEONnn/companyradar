      ...
      <div className="prose prose-slate max-w-none space-y-6 text-sm text-slate-700">
        ...
        <section>
          ...
          <p>
            ...
            요구하는 경우 외에는 이를 제3자에게 제공하지 않습니다. 이용자는 언제든지 데이터를
            내보내거나 계정을 삭제할 수 있습니다.
          </p>
        </section>

        <section>
          <h2 className="mb-2 text-base font-semibold text-slate-800">제4조 (서비스 변경 및 중단)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-semibold text-slate-800">제5조 (면책)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-semibold text-slate-800">제6조 (문의)</h2>
          <p>
            이용약관에 관한 문의는{" "}
